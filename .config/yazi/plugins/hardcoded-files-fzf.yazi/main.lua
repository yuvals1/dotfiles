local function fail(s, ...)
  ya.notify { title = 'Hardcoded-Fzf', content = string.format(s, ...), timeout = 5, level = 'error' }
end

-- Define the hardcoded list of files here
local function get_hardcoded_files()
  -- Replace these paths with your desired files
  return {
    -- Examples (modify according to your needs):
    '/Users/yuvalspiegel/dev',
    '/Users/yuvalspiegel/dotfiles',
    '/Users/yuvalspiegel/treex-mono/robopilot',
...
local function entry()
  ...
  -- Get hardcoded files
  local files = get_hardcoded_files()

  if #files == 0 then
    return fail 'No files defined in the hardcoded list'
  end
