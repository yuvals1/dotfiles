...
source "$SCRIPT_DIR/scripts/install_clangd.sh"
source "$SCRIPT_DIR/scripts/install_github_cli.sh"
source "$SCRIPT_DIR/scripts/install_zoxide.sh"
source "/Users/yuvalspiegel/dotfiles/ubuntu_setup/scripts/install_go.sh"
source "/Users/yuvalspiegel/dotfiles/ubuntu_setup/scripts/setup_lazygit_local.sh"
...
main() {
    ...
    command -v clangd >/dev/null && echo "✓ clangd" || echo "✗ clangd"
